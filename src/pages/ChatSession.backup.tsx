...
export function ChatSession() {
  ...
  return (
    <div style={{ height: "100%", overflow: "auto", WebkitOverflowScrolling: "touch" }}>
      {/* Header — sticky top */}
      <div
        className="flex items-center gap-3 px-4 py-3 border-b border-[var(--border)] bg-[var(--background)]"
      ...
      {/* Terminal content — tall enough to fill the view */}
      ...
      <div
        className="flex gap-2 px-4 pt-3 border-t border-[var(--border)] bg-[var(--surface)] input-bar"
