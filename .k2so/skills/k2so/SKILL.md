---
name: k2so
description: K2SO workspace commands — send work to agents, view activity, manage connections
---

# K2SO Skill

This workspace (K2SO-companion) is managed by K2SO. You can use these commands to interact with the agent system.
